...
namespace ERP_BASE.App_Code.Negocio.Catalogos
{
    class Cls_Cat_Impresoras_Cajas_Negocio
    {
        ...
        public Cls_Cat_Impresoras_Cajas_Negocio Obtener_Impresoras_Cajas()
        {
            ...
            {
                Neg_Impresoras_Cajas.P_Caja_ID = Dt_Impresoras_Cajas.Rows[0][Cat_Impresoras_Cajas.Campo_Caja_ID].ToString();
                Neg_Impresoras_Cajas.P_Impresora_Pago = Dt_Impresoras_Cajas.Rows[0][Cat_Impresoras_Cajas.Campo_Impresora_Pago].ToString();
                Neg_Impresoras_Cajas.P_Impresora_Accesos = Dt_Impresoras_Cajas.Rows[0][Cat_Impresoras_Cajas.Campo_Impresora_Accesos].ToString();
                Neg_Impresoras_Cajas.P_Impresora_Servicios = Dt_Impresoras_Cajas.Rows[0][Cat_Impresoras_Cajas.Campo_Impresora_Servicios].ToString();
            }
