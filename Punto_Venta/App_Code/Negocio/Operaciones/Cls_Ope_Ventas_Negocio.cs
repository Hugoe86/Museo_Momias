...
namespace Erp_Ope_Ventas.Negocio
{
    public class Cls_Ope_Ventas_Negocio
    {
        ...
        public String P_Lugar_Venta
        {
            get { return Lugar_Venta; }
            set { Lugar_Venta = value; }
        }
        //Grupos
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        public String Alta_Ventas()
        {
            return Cls_Ope_Ventas_Datos.Alta_Pago(this);
        }
        ///*******************************************************************************
        ///NOMBRE DE LA FUNCIÓN : Realizar_Pago_Grupo
        ///DESCRIPCIÓN          : 
        ///PARAMETROS           : 
        ///CREO                 : 
        ///FECHA_CREO           : 
        ...
        ///CAUSA_MODIFICACIÓN   :
        ///*******************************************************************************
        public String  Realizar_Pago_Grupo() { return Cls_Ope_Ventas_Datos.Realizar_Pago_Grupo(this); }
        #endregion
