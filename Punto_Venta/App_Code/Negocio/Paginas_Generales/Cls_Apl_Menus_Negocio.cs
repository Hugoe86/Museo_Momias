using System;
using Erp_Apl_Menus.Datos;

namespace Erp_Apl_Menus.Negocio
{
    public class Cls_Apl_Menus_Negocio
    {
        ...
        #region Variables Internas
            ...
            private String Nombre_Mostrar = String.Empty;
        ...
        #region Variables Publicas
            ...
            public String P_Nombre_Mostrar
            {
                get { return Nombre_Mostrar; }
                set { Nombre_Mostrar = value; }
            }
        ...
        #region Metodos
            ...
            {
                Cls_Apl_Menus_Datos.Alta_Menu(this);
            }

            public void Modificar_Menu()
            {
                Cls_Apl_Menus_Datos.Modificar_Menu(this);
            }
            ...
            {
                return Cls_Apl_Menus_Datos.Consultar_Menus(this);
            }
            ...
            ///CAUSA_MODIFICACIÓN   :
            ///*******************************************************************************
            public Cls_Apl_Menus_Negocio Consultar_Detalles_Menu()
            {
                return Cls_Apl_Menus_Datos.Consultar_Detalles_Menu(this);
            }

            public void Eliminar_Menu()
            {
                Cls_Apl_Menus_Datos.Eliminar_Menu(this);
            }
