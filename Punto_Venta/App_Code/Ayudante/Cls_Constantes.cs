...
namespace Erp.Constantes
{
    public class Cls_Constantes
    {
        ...
        public static string Nombre_Base_Datos = "momias";

        //  cadena de conexion del deudorcad
        public static String Odbc_Conexion = "DRIVER={MySQL ODBC 3.51 Driver};" +
                                 "SERVER=localhost;" +
                                 "DATABASE=deudorcadcontel;" +
                                 "UID=contel;" +
                                 "PASSWORD=c0nt3l;" +
                                 "OPTION=3";
    }
    ...
    public class Cat_Productos
    {
        ...
        public const String Campo_Relacion_Producto_Id = "Relacion_Producto_Id";
    }
    ...
    public class Cat_Parametros
    {
        ...
        public const String Campo_Odbc = "Odbc";
        ...
        public const String Campo_Version_Bd = "Version_Bd";
